...
# Il modo più affidabile per ottenere un ExpressionSet
# getGEO restituirà una lista di ExpressionSet, quindi ne estrai il primo.
A <- getGEO("GSE76999", GSEMatrix = TRUE, getGPL = FALSE)

# Se il dataset contiene una sola matrice, estraila dal primo elemento della lista
B <- A[[1]]

# Ora puoi ispezionare l'oggetto ExpressionSet
varLabels(B)
